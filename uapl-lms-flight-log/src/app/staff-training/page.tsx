...
export default function StaffTrainingPage() {
  ...
  async function loadPage() {
    setLoading(true);
    try {
      const nextDescriptions = await fetchStaffTrainingDescriptions();
      setDescriptions(nextDescriptions);

      if (routeMode === "records") {
  ...
  async function loadRecordsPage(
    ...
    const requestId = ++recordsRequestSequence.current;
    ...
    try {
      ...
      const result = await fetchStaffTrainingRecordsPage(request);
      ...
      if (requestId === recordsRequestSequence.current) {
