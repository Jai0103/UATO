...
const actionLabels: Record<string, string> = {
  ...
  STAFF_TRAINING_CREATED: "Staff Training record created",
  STAFF_TRAINING_UPDATED: "Staff Training record updated",
  STAFF_TRAINING_DELETED: "Staff Training record deleted",
  STAFF_TRAINING_DESCRIPTIONS_UPDATED: "Staff Training descriptions updated",
