...
export default function InventoryPage() {
  ...
  return (
    <AppShell>
      ...
      {viewing ? <AssetDetailModal detail={viewing} onClose={() => setViewing(null)} /> : null}
